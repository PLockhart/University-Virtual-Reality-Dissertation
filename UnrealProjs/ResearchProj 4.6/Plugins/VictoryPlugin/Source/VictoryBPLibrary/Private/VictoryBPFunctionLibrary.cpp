...
FString UVictoryBPFunctionLibrary::String__CombineStrings_Basic(FString StringFirst, FString StringSecond)
{
...
void UVictoryBPFunctionLibrary::SetHudAtRunTime(APlayerController* PlayerController, TSubclassOf<AHUD> NewHUD)
{
	if(!PlayerController) 	return;
	if(!NewHUD) 			return;
	PlayerController->ClientSetHUD(NewHUD);
} 
