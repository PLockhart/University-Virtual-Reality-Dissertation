...
class VICTORYBPLIBRARY_API UVictoryBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "VictoryBPLibrary")
	static FString String__CombineStrings_Basic(FString StringFirst, FString StringSecond);
	...
	/**
	*
	* Contributed by: Sahkan
	*
	* Sets the HUD for a player at runtime
	*/
	UFUNCTION(BlueprintCallable, Category = "VictoryBPLibrary|HUD")
	static void SetHudAtRunTime(APlayerController* PlayerController, TSubclassOf<AHUD> NewHUD);
	...
	*/
	UFUNCTION(BlueprintPure, meta = (FriendlyName = "Explode string", Keywords = "split explode string"), Category = "VictoryBPLibrary")
