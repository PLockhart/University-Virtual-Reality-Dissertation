...
FNewSkeletonDetectedEventTest UKinectFunctionLibrary::NewSkeletonDetectdEventTest;
...
UKinectFunctionLibrary::UKinectFunctionLibrary(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{
...
FVector UKinectFunctionLibrary::GetDirVec(const FVector& From, const FVector& To){
	...
	FVector retVec = (To - From).SafeNormal();
...
FNewSkeletonDetectedEventTest& UKinectFunctionLibrary::GetNewSkeletonDetectdEventTest()
{
	return NewSkeletonDetectdEventTest;
}
